        ...
        <div class="recruit_detail_box cf">
            ...
            <div class="notice_box rd_left">
                ...
                <div class="notice_task">
                    <h3>주요업무</h3>
                    <span class="notice_txt"
                        >사내 플랫폼과 외부 광고 플랫폼들이 제공하는 기능 및
                        데이터들을 통합하고 사용성 개선</span
                    >
                </div>
                <!-- .notice_task -->
                ...
                <div class="notice_skill">
                    <h3>자격요건</h3>
                    <span class="notice_txt"
                        >Java, Javascript, jsp, html, css</span
                    >
                </div>
                <!-- .notice_skill -->
            ...
            <div class="company_box rd_right">
                ...
                /></span>
                <span class="info_tit"
                    ><em>회사명</em><strong>PROJECT4</strong></span
                >
                ...
                <span class="info_task"
                    ><em>주요업무</em
                    ><strong>서버관리 및 프로그램 설계</strong></span
                >
                <span class="info_ssar"
                    ><em>평균연봉</em><strong>4000</strong></span
                >
                ...
                <div class="form_box">
                    <ul>
                        <li class="resume_select_cont">
                            ...
                            <label
                                for="resume_select"
                                class="resume_select_box"
                            >
                                <span class="tit"
                                    >최상의 결과를 이끌어 낼 4조 개발자들
                                    화이팅</span
                                >
