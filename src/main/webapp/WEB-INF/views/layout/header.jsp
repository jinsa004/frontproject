      ...
      <div class="modal_join_wrap">        
          ...
          <div class="form_box cf">
            <form action="/join" method="post">
              ...
              <span>
                <input id="id" type="text" placeholder="아이디를 입력하세요." value="${username}" maxlength="20">
              </span>
            </div>
            ...
            <div class="company_info">
              <div class="join_number join_box">
                ...
                <span>
                  <input id="c_number" type="text" placeholder="사업자 등록번호를 입력하세요." name="companyNumber" maxlength="40">
                </span>
              </div>
              <div class="join_birth join_box">
                ...
                <span>
                  <input id="c_birth" type="date" placeholder="생년월일을 입력하세요." name="companyBirth" maxlength="40">
                </span>
              </div>
              <div class="join_phone join_box">
                ...
                <span>
                  <input id="c_phone" type="tel" placeholder="휴대폰번호를 입력하세요." name="companyPhone" maxlength="40">
                </span>
              </div>
              <div class="join_adress join_box">
                ...
                <span>
                  <input id="c_adress" type="text" placeholder="주소를 입력하세요." name="companyAdress" maxlength="100">
                </span>
              </div>
            </div>
          </div>
          ...
          <div class="join_right">
            ...
            <button id="btn_join" type="button" class="btn btn-primary">회원가입</button>
          </div>
      </div>
