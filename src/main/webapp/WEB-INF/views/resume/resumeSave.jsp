        ...
        <div class="resume_update">
            ...
            <div id="info" class="form">
                ...
                <div class="info_form">
                    ...
                    <dl class="info_name">
                        <dd class="name">${employeePS.employeeName}</dd>
                        <dd class="sex">${employeePS.employeeSex}, ${employeePS.employeeBirth}</dd>
                    </dl>
                    <dl class="info_basic">
                        <dt class="info_list_item">${employeePS.employeeEmail}</dt>
                        <dt class="info_list_item">${employeePS.employeeTel}</dt>
                        <dt class="info_list_item">${employeePS.employeeLocation}</dt>
                    </dl>
                </div>
            </div>
            <!-- info -->
                ...
                <div class="resume_edu">
                    ...
                    <div class="edu_form" id="highschool">
                        ...
                        <div class="edu_row">
                            ...
                            <div class="edu_input">
                                <input type="text" id="highschool_start_date" name="start_date" class="box_input"
                                    placeholder="입학년도" />
                                <input type="text" id="highschool_end_date" name="end_date" class="box_input"
                                    placeholder="졸업년도" />
                            </div>
                        </div>
                        <div class="edu_row">
                            ...
                            <div class="edu_input">
                                <input type="text" id="highschool_major" name="highschool_major" class="box_input"
                                    placeholder="전공계열" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="edu_form" id="univ">
                        ...
                        <div class="edu_row">
                            ...
                            <div class="edu_input">
                                <input type="text" id="univ_name" name="univ_name" class="box_input"
                        ...
                        <div class="edu_row">
                            ...
                            <div class="edu_input">
                                <input type="text" id="univ_start_date" name="start_date" class="box_input"
                                    placeholder="입학년도" />
                                <input type="text" id="univ_end_date" name="end_date" class="box_input"
                                    placeholder="졸업년도" />
                            </div>
                        </div>
                        <div class="edu_row">
                            ...
                            <div class="edu_input">
                                <input type="text" id="univ_major" name="univ_major" class="box_input"
                                    placeholder="전공 입력" />
                            </div>
                        </div>
                        <div class="edu_row">
                    ...
                    <div class="career_form" id="work">
                        ...
                        <div class="career_row">
                            ...
                            <div class="career_input">
                                <input type="text" id="career_name" name="career_name" class="box_input"
                        ...
                        <div class="career_row">
                            ...
                            <div class="career_input">
                                <input type="text" id="career_period" name="start_date" class="box_input"
                        ...
                        <div class="career_row">
                            ...
                            <div class="career_input">
                                <input type="text" id="career_task" name="career_task" class="box_input"
