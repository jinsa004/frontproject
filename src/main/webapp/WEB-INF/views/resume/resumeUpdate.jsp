      ...
      <div class="resume_update">
        ...
        <div id="info" class="form">
          ...
          <div class="info_form">
            ...
            <dl class="info_name">
              <dd class="name">${resumePS.employeeName}</dd>
              <dd class="sex">${resumePS.employeeSex}, ${resumePS.employeeBirth}</dd>
            </dl>
            <dl class="info_basic">
              <dt class="info_list_item">${resumePS.employeeEmail}</dt>
              <dt class="info_list_item">${resumePS.employeeTel}</dt>
              <dt class="info_list_item">${resumePS.employeeLocation}</dt>
            </dl>
          </div>
        </div>
        <!-- info -->
