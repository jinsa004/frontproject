    ...
    <div class="users_form">
      ...
      <div id="contact_info" class="form">
        ...
        <div class="contact_form">
          <dl class="info_contact">
            ...
            <input type="text" id="user_location" name="user_location" class="box_input" value="부산 금정구" placeholder="주소를 입력하세요"/>
          </dl>
        </div>
      </div>
      <!-- contact -->
      ...
      <div id="login_info" class="form">
        ...
        <dl class="info_login">
          ...
          <input type="text" id="user_tel" name="user_tel" class="box_input" value="ssar" placeholder="휴대폰 번호을 입력하세요"/>
          <dt class="info_list_item">Password</dt>
          <input type="text" id="user_email" name="user_email" class="box_input" value="1234" placeholder="이메일을 입력하세요"/>
        </dl>
        </div>
      </div>
      <!-- login -->
